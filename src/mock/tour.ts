...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    say: 'And this is what we have actually verified: the data path checked live, the baseline run recorded, and every risk paired with the experiment that settles it.',
    note: 'Results appear only where the work has been done. Three of the six experiments are still marked planned, and they carry no figures — inventing one would defeat the point.',
    screen: 'feasibility',
    target: 'risk-register',
    hold: 10000,
    onEnter: (a) => a.navigate('feasibility'),
  },
  {
    id: 'close',
    chapter: 'Evidence',
